...
class _TermsConditionsViewState extends State<TermsConditionsView> {
  var whiteCard = Colors.white;
  var greyCard = Color.fromARGB(255, 245, 245, 245);
  var blueCard = Colors.lightBlue;
  var titleColor = Colors.white;
  var titleColor2 = Colors.black;
  var subTitle = Colors.white;
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            //   height: 10,
            // ),
            //CatlogCard('Compliance', 'This privacy policy complies e-commerce industry best practice guidelines. If you have questions or concerns about this policy please contact us using the information provided below. ', newTwoColor, titleColor2, subTitle2),

            getCard(
                'Study Evaluation Website Terms Of Use ',
...
getCard(String label, String text, Color customColor, Color titleColor,
    Color subtitle) {
  return Column(
      ...
      Card(
        ...
        child: ListTile(
          ...
          subtitle: Padding(
            ...
            child: Text(text,
                style: TextStyle(
                  color: subtitle, fontSize: 15, //fontFamily: 'Montserrat'
                ),
