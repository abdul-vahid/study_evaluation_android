...
class _ResultScreenState extends State<ResultScreen> {
  ...
  SingleChildScrollView _getBody(BuildContext context) {
    return SingleChildScrollView(
        child: Column(children: _getScrollViewChild(context)));
  }

  List<Widget> _getScrollViewChild(BuildContext context) {
    return [
      Padding(
        ...
        child: Container(
            ...
            child: Container(
                ...
                child: _getLeaderboardSection(context))),
      ),
      const SizedBox(
        height: 20,
      ),
            ...
            child: Row(
              children: <Widget>[
                ...
                Padding(
                    ...
                    child:
                        Container(color: AppColor.containerBoxColor, width: 2)),
                Expanded(
                    child: InkWell(
                        onTap: () {
                          Navigator.push(
          ...
          children: [
            ...
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                ...
                side: BorderSide(width: 2.0, color: AppColor.containerBoxColor),
              ),
              onPressed: () {},
  ...
  Row _getLeaderboardSection(BuildContext context) {
    return Row(
      children: <Widget>[
        Expanded(
            child: InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const LearderbordView()),
                  );
                },
                child: Container(
                  alignment: Alignment.center,
        ...
        Padding(
            padding: EdgeInsets.symmetric(vertical: 8),
            child: Container(color: Color(0xFFe0d9cd), width: 2)),
        Expanded(
            child: InkWell(
                onTap: () {
